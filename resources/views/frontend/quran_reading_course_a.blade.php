        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-angle-double-right"></i> Quran Reading Course Adults</li>
                </ul>
            </div>
        </div>
    </div>

    <!-- ######## Quran Reading Course Adults Information Starts Here ####### -->

    <div class="row contact-rooo no-margin">
        <div class="container">
            <div style="padding:20px">
                <h2>Quran Reading Course Adults</h2>
                <div class="mt-lg-5">
                    {!! $campusmale->Quran_Reading_Course_a !!}
