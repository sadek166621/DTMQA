        ...
        <div class="container">
            <div class="row">
                ...
                <ul>
                    ...
                    <li><i class="fas fa-angle-double-right"></i> Quran Memorization Course Kids</li>
                </ul>
            </div>
        </div>
    </div>

    <!-- ######## Quran Memorization Course Kids Information Starts Here ####### -->

    <div class="row contact-rooo no-margin">
        <div class="container">
            <div style="padding:20px">
                <h2>Quran Memorization Course Kids</h2>
                <div class="mt-lg-5">
                    {!! $campusfemale->Quran_Memorization_Course !!}
